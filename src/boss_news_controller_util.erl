...
% Record construction #state{watch_dict::dict:dict(),ttl_tree::{number(),'nil' | {_,_,'nil' | {_,_,_,_},_}},set_watchers::dict:dict(),id_watchers::dict:dict(),set_attr_watchers::dict:dict(),id_attr_watchers::dict:dict(),watch_counter::integer()}%
%violates the declared type of field ttl_tree::gb_tree()
-spec prune_expired_entries(#state{ttl_tree::gb_tree:tree()}) -> #state{ttl_tree::gb_tree:tree()}.
